     ...
     const columns = [
      ...
      return (
          <div align="left" >
            ...
            <Button component={Link} to={{pathname:'/add/assignment',   assignment: assignmentSelected }} 
                      variant="contained" color="primary" disabled={this.state.assignments.length===0}  style={{margin: 10}}>
              Add Assignment
            </Button>
